...
class FactorEmaAskHugeOrderMultipleDuration(Factor):
    def __init__(self, para, factorManagement):
        ...
        self.__emaAskHugeOrderMultiple = self.getFactorData({"name": "emaAskHugeOrderMultiple",
    ...
    def calculate(self):
        ...
        if self.getContent().__len__() >= 1:
            datanow = self.__emaAskHugeOrderMultiple.getLastContent() - self.__paraHorizon
            datalast = self.__emaAskHugeOrderMultiple.getContent()[-2] - self.__paraHorizon
