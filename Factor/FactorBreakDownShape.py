...
class FactorBreakDownShape(Factor):
            ...
            if length >= 2:
                for i in range(1, length):
                    if extremePointInfo[i][0] == -1:
                        for j in range(0, i):
                            ...
                            if extremePointInfo[j][0] == 1 and tempMinPrice == extremePointInfo[i][1] and \
                                    tempMaxPrice == extremePointInfo[j][1]:
                                ...
                                for k in range(i, length):
                                    ...
                                    if extremePointInfo[k][1] > tempMaxPrice:
                                        tempMaxPrice = extremePointInfo[k][1]
                                if tempMaxPrice <= (
                                        (1 - self.__paraHighestRatio) * extremePointInfo[j][1] + self.__paraHighestRatio
                                        * extremePointInfo[i][1]) and tempMinPrice == extremePointInfo[i][1]:
                                    # if 1 - extremePointInfo[i][1] / extremePointInfo[j][1] >= self.__paraDecreaseRate:
                ...
                if len(tempLinesEnd) >= 1:
                    ...
                    for i in range(len(uniqueLinesEnd)):
                        ...
                        linesStart = max(tempLinesStart2)
            ...
            if len(lines) == 0:
                ...
                for i in range(len(lines)):
                    ...
                    if  tempValue < preValue:
                        factorValue = 1 - lines[i][0] / lines[i][1]
