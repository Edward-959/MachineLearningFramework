...
class FactorLREmaBidHugeOrderMultiple(Factor):
    def __init__(self, para, factorManagement):
        ...
        paraRegressionEmaBidHugeOrderMultiple = {"name": "LinearRegressionEmaBidHugeOrderMultiple",
                                                 ...
                                                 "paraOriginalData": {"name": "emaBidHugeOrderMultiple",
        ...
        self.__regressionEmaBidHugeOrderMultiple = self.getFactorData(paraRegressionEmaBidHugeOrderMultiple)

        factorManagement.registerFactor(self, para)

    def calculate(self):
        self.addData(self.__regressionEmaBidHugeOrderMultiple.getLastContent(), self.__data.getLastTimeStamp())
