...
class FactorLREmaAskHugeOrderMultiple(Factor):
    def __init__(self, para, factorManagement):
        ...
        paraRegressionEmaAskHugeOrderMultiple = {"name": "LinearRegressionEmaAskHugeOrderMultiple",
                                                 ...
                                                 "paraOriginalData": {"name": "emaAskHugeOrderMultiple",
                                                                      "className": "FactorEmaAskHugeOrderMultiple",
                                                                      "indexTradingUnderlying": self.getIndexTradingUnderlying(),
                                                                      "indexFactorUnderlying": self.getIndexFactorUnderlying(),
        ...
        self.__regressionEmaAskHugeOrderMultiple = self.getFactorData(paraRegressionEmaAskHugeOrderMultiple)

        factorManagement.registerFactor(self, para)

    def calculate(self):
        self.addData(self.__regressionEmaAskHugeOrderMultiple.getLastContent(), self.__data.getLastTimeStamp())
